...
import numpy as np
import json
from optical_flow.base import OPTICAL_FOLDER, DATASET_FOLDER, POSE_OUTPUT_FOLDER
import os
from optical_flow.optical_flow import get_optical_flow
...
# データセットにオプティカルフローの座標を追加
def add_optical_flow_to_dataset():
